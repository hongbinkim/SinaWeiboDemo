...
//    Weibo
    ...
    public static final String HOME_TIMELINE = URL_SINA_WEIBO + "statuses/home_timeline.json";
    ...
    public static final String APP_KEY = "308955607";

    public static final String APP_SECRET = "b974eaa822f53ee136a5c8beda1ddbaf";
    ...
    //topic
    public static final String TOPIC_HOURLY_LIST = URL_SINA_WEIBO + "trends/hourly.json";
    public static final String TOPIC_DAILY_LIST = URL_SINA_WEIBO + "trends/daily.json";
    public static final String TOPIC_WEEKLY_LIST = URL_SINA_WEIBO + "trends/weekly.json";
